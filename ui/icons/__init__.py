...
PROXIES_MENU_ICON = os.path.join(ICONS_DIR, "proxies.png")
START_ICON = os.path.join(ICONS_DIR, "start.png")
STOP_ICON = os.path.join(ICONS_DIR, "stop.png")
DOWN_ARROW_ICON = os.path.join(ICONS_DIR, "down-arrow.png")
...
WEB3_ICON = os.path.join(ICONS_DIR, "web3.png")
